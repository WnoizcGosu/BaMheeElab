...
import { Edit3, Award, Code2, TrendingUp } from "lucide-react";
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-1 space-y-4">
            ...
            {/* Profile hero */}
            <div className="bg-brand-red rounded-2xl p-5 text-white relative overflow-hidden">
              ...
              <div className="flex items-start gap-4 relative z-10">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-bold text-base">worachot_dev</div>
                  <div className="text-white/70 text-sm">8 Solved ✅</div>
                </div>
              </div>
            </div>
